    ...
    public class ReturnAdoptionCertfcate : IReturnAdoptionCertfcate
    {
        ...
        AdoptionCertificateDTO IReturnAdoptionCertfcate.GetAdoptionCertificate(AdoptionEvent adoption, string? BirthCertNo)
        {
            ...
            return new AdoptionCertificateDTO()
            {
                ...
                BirthMonth = new EthiopicDateTime(convertor.getSplitted(adoption.Event.EventOwener.BirthDateEt).month, "or").month,
                ...
                EventRegisteredMonth = new EthiopicDateTime(convertor.getSplitted(adoption.Event.EventRegDateEt).month, "or").month,
                ...
                GeneratedMonth = new EthiopicDateTime(convertor.getSplitted(CreatedAtEt).month, "or").month,
