...
{
    public class UpdateDamagedCertificatesCommandValidator : AbstractValidator<UpdateDamagedCertificatesCommand>
    {
        private readonly ICertificateRangeRepository _repo;
        // private readonly IMediator _mediator;
        public UpdateDamagedCertificatesCommandValidator(ICertificateRangeRepository repo)
        {
