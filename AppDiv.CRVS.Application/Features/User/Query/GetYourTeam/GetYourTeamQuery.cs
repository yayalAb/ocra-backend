...
namespace AppDiv.CRVS.Application.Features.User.Query.GetYourTeam
{
    public class GetYourTeamQuery : IRequest<object>
    {
    ...
    public class GetYourTeamQueryHandler : IRequestHandler<GetYourTeamQuery, object>
    {
        ...
        public GetYourTeamQueryHandler(IUserRepository userRepository, IOnlineUserRepository onlineUserRepository)
        {
            _userRepository = userRepository;
            _onlineUserRepository = onlineUserRepository;
        }
        public async Task<object> Handle(GetYourTeamQuery request, CancellationToken cancellationToken)
        {
