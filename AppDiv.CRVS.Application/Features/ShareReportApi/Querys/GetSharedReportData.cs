...
namespace AppDiv.CRVS.Application.Features.ShareReportApi.Querys
{
    ...
    public record GetSharedReportData : IRequest<object>
    {
    ...
    public class GetSharedReportDataHandler : IRequestHandler<GetSharedReportData, object>
    {
        ...
        public GetSharedReportDataHandler(IReportRepostory reportRepo, ISharedReportRepository reportRepository, IUserResolverService UserResolver, IUserRepository userReportory)
        {
        ...
        public async Task<object> Handle(GetSharedReportData request, CancellationToken cancellationToken)
        {
