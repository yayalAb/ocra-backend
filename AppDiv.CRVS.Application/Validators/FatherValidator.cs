...
namespace AppDiv.CRVS.Application.Validators
{
    public class FatherValidator : AbstractValidator<FatherInfoDTO>
    {
        ...
        {
            _repo = repo;
            RuleFor(p => p.Id.ToString()).NotEmpty().NotNull().ForeignKeyWithPerson(_repo, "Father.Id")
            ...
            RuleFor(p => p.NationalityLookupId.ToString()).NotEmpty().NotNull().ForeignKeyWithLookup(_repo, "Father.NationalityLookupId");
            // .When(p => p.NationalityLookupId != null);
            RuleFor(p => p.ReligionLookupId.ToString()).NotEmpty().NotNull().ForeignKeyWithLookup(_repo, "Father.ReligionLookupId")
            .When(p => p.ReligionLookupId != null);
            RuleFor(p => p.EducationalStatusLookupId.ToString()).NotEmpty().NotNull().ForeignKeyWithLookup(_repo, "Father.EducationalStatusLookupId")
            .When(p => p.EducationalStatusLookupId != null);
            RuleFor(p => p.TypeOfWorkLookupId.ToString()).NotEmpty().NotNull().ForeignKeyWithLookup(_repo, "Father.TypeOfWorkLookupId")
            .When(p => p.TypeOfWorkLookupId != null);
            RuleFor(p => p.MarriageStatusLookupId.ToString()).NotEmpty().NotNull().ForeignKeyWithLookup(_repo, "Father.MarriageStatusLookupId")
            .When(p => p.MarriageStatusLookupId != null);
            RuleFor(p => p.ResidentAddressId.ToString()).NotEmpty().NotNull().ForeignKeyWithAddress(_repo, "Father.ResidentAddressId")
            .When(p => p.ResidentAddressId != null);
            RuleFor(p => p.NationLookupId.ToString()).NotEmpty().NotNull().ForeignKeyWithLookup(_repo, "Father.NationLookupId")
            ...
            RuleFor(p => p.BirthAddressId.ToString()).NotEmpty().NotNull().ForeignKeyWithAddress(_repo, "Father.BirthAddressId")
