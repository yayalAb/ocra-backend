...
namespace AppDiv.CRVS.Infrastructure.Services
{
...

    {
        ...
        public static void IndexPersonalInfo(List<PersonalInfoEntry> personalInfoEntries, CRVSDbContext _dbContext)
        {
            ...
            List<object> addedPersonIndexes = new List<object>();
            ...
            BackgroundJob.Enqueue<IBackgroundJobs>(x => x.AddIndex<PersonalInfoIndex>(addedPersonIndexes, "personal_info"));
            BackgroundJob.Enqueue<IBackgroundJobs>(x => x.UpdateIndex<PersonalInfoIndex>(updatedPersons, "personal_info"));
